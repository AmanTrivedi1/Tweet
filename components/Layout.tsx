          ...
          <div className="flex w-full justify-center lg:justify-end">
            <div className="w-60 flex flex-col items-center lg:items-start gap-6">
              ...
              <Link className="flex items-center gap-4 px-0 lg:px-8" href="/">
                ...
                <p
                  className={`text-lg hidden lg:inline-flex ${
              ...
              <Link
                className="flex items-center gap-4 px-0 lg:px-8"
                href="/bookmarks"
              >
                ...
                <p
                  className={`text-lg hidden lg:inline-flex ${
                    router.pathname == "/bookmarks" ? "font-bold" : "font-light"
                  }`}
                >
                  Bookmarks
                </p>
              ...
              >
                ...
                <p
                  className={`text-lg hidden lg:inline-flex ${
                    router.pathname == "/profile" ? "font-bold" : "font-light"
                  }`}
                >
                  Profile
                </p>
              ...
              >
                ...
                <p className="text-lg hidden lg:inline-flex font-light">
                  Logout
                </p>
              </button>
            </div>
