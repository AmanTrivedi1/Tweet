...
//             <div
//               onClick={() => setBase64("")}
//               className="absolute top-4 right-4 h-8 w-8 flex items-center justify-center rounded-full bg-black bg-opacity-50 hover:bg-opacity-40 cursor-default"
//             >
...
//             disabled={sending}
//             onClick={submit}
//             className="bg-blue-500 hover:bg-blue-600 font-bold w-24 h-10 flex items-center justify-center rounded-full"
//           >
//             {sending ? (
