    ...
    return (
      <div className="h-screen overflow-y-scroll flex-grow bg-black text-white">
        ...
        <div className="w-full flex relative -top-16">
          <div className="w-full lg:w-3/5 grow-0 shrink-0 p-8 min-h-screen flex items-center justify-center">
            Loading...
          </div>
            ...
            <div className="border-b border-neutral-600 p-4">
              <div className="relative mb-8 flex justify-between items-start">
                <div
                  {...getRootProps({
                    className:
                      "absolute top-9 left-9 hover:bg-neutral-900 hover:bg-opacity-30 rounded-full p-2 cursor-pointer w-fit",
                  })}
                >
                  <input {...getInputProps()} />
                ...
                <button
                  ...
                  className="w-24 h-10 flex items-center justify-center bg-blue-500 rounded-full"
                >
                  {updating ? (
